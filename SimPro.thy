...
definition inference :: "sequent \<Rightarrow> sequent list" where (* l f multi *)
  "inference l = (case l of [] \<Rightarrow> [[]] | ((n,f)#t) \<Rightarrow> (case f of
  ...
  | Uni f \<Rightarrow> [t @ [(0,finst f (fresh (fv_list (list_sequent l))))]]
